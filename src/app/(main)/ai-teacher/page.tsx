...
export default function AITeacherPage() {
  ...
  const getStatusIndicator = () => {
    ...
    switch(conversationStatus) {
      ...
      case 'thinking':
        return <div className="flex items-center gap-2 text-secondary"><Loader2 className="w-4 h-4 animate-spin" />सोच रहा है...</div>;
      case 'speaking':
        return <div className="flex items-center gap-2 text-purple-400"><Bot className="w-4 h-4" />बोल रहा है...</div>;
      default:
        return <div className="flex items-center gap-2 text-muted-foreground">निष्क्रिय</div>;
    }
  }
